...
export default function Notification() {
  return (
    <button className="relative h-[32px] w-[32px] flex items-center justify-center rounded-full bg-[#F3EFF6] hover:bg-[#f3eff6] transition-all duration-200 ease-in-out">
