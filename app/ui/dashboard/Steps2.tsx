...
export default function Steps2() {
  ...
  // ✅ Adjusted step counter logic for 4 total steps (excluding optional brand kit)
  useEffect(() => {
    ...
    // Step 4: Brand kit (optional) — not part of total step count, but we can track it
    if (primaryLogo && (brandGuide || brandGuideName)) completedSteps += 1;
