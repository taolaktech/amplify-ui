...
//   // Determine if banner should be shown (any false flag)
//   const showBanner =
//     onboarding &&
//     Object.values(onboarding).some((flag) => flag === false) &&
//     !cancelNotification;

//   // Determine next incomplete step link
//   const nextStepKey =
//     onboarding &&
//     Object.entries(onboarding).find(([_, value]) => value === false)?.[0];

//   // Map onboarding keys to actual routes
//   const onboardingRoutes: Record<string, string> = {
//     businessDetails: "/setup/business-details",
//     preferredSalesLocation: "/setup/preferred-sales-location",
//     marketingGoals: "/setup/marketing-goals",
//     connectStore: "/setup/connect-store",
//   };

//   const nextStepLink = nextStepKey
//     ? onboardingRoutes[nextStepKey] ?? "/setup"
//     : "/setup";
...
//       {/* Onboarding banner */}
//       {showBanner && (
//         <div className="transition-all duration-300 h-[112px] sm:h-[84px] lg:h-[108px] opacity-100">
//           <div className="bg-[#FEF5EA] p-5 lg:p-7 rounded-2xl flex flex-row w-full items-center justify-between gap-3 lg:gap-0">
//             <div className="flex w-full gap-3 lg:gap-4 items-start lg:items-center">
//               <span className="w-[44px] h-[44px] flex-shrink-0 bg-[#FDE0BD] flex items-center justify-center rounded-full">
//                 <Notification size={24} color="#FA9B0C" variant="Bold" />
...
//       .filter(([key]) => requiredSteps.includes(key))
//       .filter(([_, value]) => value === false);

//   // Show banner if any required step is incomplete
//   const showBanner = incompleteRequiredSteps?.length > 0 && !cancelNotification;

//   // Determine next incomplete required step
//   const nextStepKey = incompleteRequiredSteps?.[0]?.[0];
